# Contributing to socket-signal-websocket
...
Fork the project [on GitHub](https://github.com/geut/socket-signal-websocket) and check out your copy locally.

```bash
$ git clone git@github.com:username/socket-signal-websocket.git
$ cd socket-signal-websocket
$ npm install
$ git remote add upstream git://github.com/geut/socket-signal-websocket.git
```
